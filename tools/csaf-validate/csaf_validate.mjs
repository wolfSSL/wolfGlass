// CSAF 2.0 conformance gate for documents emitted by central/gen-advisory.
//
...
//
// Usage:  node tools/csaf-validate/csaf_validate.mjs <doc.csaf.json> [...]
...
if (files.length === 0) {
  console.error('usage: node tools/csaf-validate/csaf_validate.mjs <doc.csaf.json> ...')
  process.exit(2)
}
